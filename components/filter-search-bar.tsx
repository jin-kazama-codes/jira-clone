    ...
    >
      ...
      <input
        ...
        className={clsx(
          ...
          "inset-2 h-full rounded-xl border-2 dark:bg-darkSprint-20 dark:border-darkSprint-30 dark:placeholder:text-darkSprint-50 border-gray-300 bg-gray-50 px-2 py-2 text-sm outline-black transition-all duration-300 hover:bg-gray-200 focus:bg-white focus:outline-2  [&[data-state=focused]]:placeholder:text-gray-500 [&[data-state=not-focused]]:placeholder:text-transparent"
        )}
        value={localSearch}
