            ...
            <Fragment>
              ...
              <input
                ...
                className={clsx(
                  ...
                  "block h-10 w-64 rounded-xl border dark:bg-darkSprint-30 dark:border-darkSprint-20 dark:placeholder:text-darkSprint-50 dark:text-white border-gray-300 px-2 text-sm shadow-sm outline-2 transition-all duration-75"
                )}
              />
            </Fragment>
          );
