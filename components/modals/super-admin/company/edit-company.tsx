...
const EditCompanyModal = ({ children, company }) => {
  const [isOpen, setIsOpen] = useState(false);
  const { updateCompany, companyUpdating } = useCompany(company?.id);
  ...
  useEffect(() => {
    if (company) {
      setFormData({
        ...
        email: company.email || "",
        phone: company.phone || "",
        alternateNumber: company.alternateNumber || "",
        billingAddress: company.billingAddress || "",
        gst: company.gst || "",
        subscriptionType: company.subscriptionType || "Monthly",
        trialDuration: company.trialDuration || "",
        date: company.date || "",
        status: company.status || "Active",
        proMember: company.proMember || false,
      });
    }
  }, [company]);
  ...
  // Separate handler for the toggle
      ...
      <ModalPortal>
        ...
        <ModalContent>
          <div className="p-5 pb-1">
            <ModalTitle className="text-white">Update Company</ModalTitle>
